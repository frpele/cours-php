...
class Author extends \AppBundle\Entity\Author implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Author' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Author' . "\0" . 'firstname', '' . "\0" . 'AppBundle\\Entity\\Author' . "\0" . 'lastname', '' . "\0" . 'AppBundle\\Entity\\Author' . "\0" . 'birthYear', '' . "\0" . 'AppBundle\\Entity\\Author' . "\0" . 'country', '' . "\0" . 'AppBundle\\Entity\\Author' . "\0" . 'books'];
        }
